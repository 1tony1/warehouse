...
public class AddFrame extends JFrame{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (id.equals("")||username.equals("")||sex.equals("")||age.equals("")||hiredate.equals("")||typrs.equals("")){
					...
					if(tt){
						...
						JOptionPane.showMessageDialog(null, "录入成功！","信息提示",JOptionPane.INFORMATION_MESSAGE);
						setVisible(false);
						ff.updateusers();
						
					}
					else {
						JOptionPane.showMessageDialog(null, "当前用户已存在，请重试！","信息提示",JOptionPane.INFORMATION_MESSAGE);
					}
	...
	public void AddMusicFrame(mainframe ff){
		...
		JButton but1 = new JButton("录入音乐信息");
		JTextField text1 = new JTextField();
		text1.setColumns(15);
		JTextField text2 = new JTextField();
		text2.setColumns(15);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (id.equals("")||name.equals("")||type.equals("")||uploader.equals("")||amount.equals("")||sizes.equals("")){
					...
					if(tt){
						...
						JOptionPane.showMessageDialog(null, "当前音乐信息已存在，请重试！","信息提示",JOptionPane.INFORMATION_MESSAGE);
					}
	...
	public void AddGameFrame(mainframe ff){
		...
		JLabel l6 = new JLabel("文件大小:");
		JButton but1 = new JButton("录入游戏信息");
		JTextField text1 = new JTextField();
		text1.setColumns(15);
		JTextField text2 = new JTextField();
		text2.setColumns(15);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (id.equals("")||name.equals("")||type.equals("")||uploader.equals("")||amount.equals("")||sizes.equals("")){
					...
					if(tt){
						...
						JOptionPane.showMessageDialog(null, "当前游戏信息已存在，请重试！","信息提示",JOptionPane.INFORMATION_MESSAGE);
					}
	...
	public void AddLiveFrame(mainframe ff){
		...
		JButton but1 = new JButton("录入直播信息");
		JTextField text1 = new JTextField();
		text1.setColumns(15);
		JTextField text2 = new JTextField();
		text2.setColumns(15);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (id.equals("")||name.equals("")||type.equals("")||uploader.equals("")||spectators.equals("")){
					...
					if(tt){
						...
						JOptionPane.showMessageDialog(null, "当前直播信息已存在，请重试！","信息提示",JOptionPane.INFORMATION_MESSAGE);
					}
